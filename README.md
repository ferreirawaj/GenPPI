...
O software GenPPI é fruto de meu projeto de mestrado em Ciências da Computação (linha de pesquisa: Inteligência Artificial) desenvolvido na Universidade Federal de Uberlândia/MG (campus Santa Mônica), e orientado pelo Professor Anderson Rodrigues dos Santos do programa de pós-graduação da FACOM/UFU.
...
Tenho uma apresentação no YouTube na qual falo com mais detalhes sobre a proposta desse projeto, implementação e alguns resultados que tivemos com o GenPPI (para assistir, [clique aqui](https://www.youtube.com/watch?v=9VGUr6NGOmk)). 
